...
router.post("/api/orders", async (req, res, params, body) => {
  ...
  // Appel au module de paiement — aujourd'hui simulé (voir payments.js),
  // demain le vrai point d'entrée CinetPay. Une erreur ici ne doit jamais
  // laisser la commande dans un état bancal : elle est déjà créée dans la
  // transaction ci-dessus, on se contente d'enregistrer la référence.
  try {
